...
export class ConfigManager {
  ...
  async setApiKey(provider: 'openai' | 'google' | 'azure' | 'xai' | 'qwen3-coder' | 'deepseek-r1', apiKey: string | undefined): Promise<void> {
    await this.ensureInitialized();
    if (!this.store) {
      throw new Error('Configuration store not initialized');
    }
  ...
  async getApiKey(provider: 'openai' | 'google' | 'azure' | 'xai' | 'qwen3-coder' | 'deepseek-r1'): Promise<string | undefined> {
    await this.ensureInitialized();
    if (!this.store) {
      throw new Error('Configuration store not initialized');
    }
  ...
  async setBaseURL(provider: 'openai' | 'google' | 'azure' | 'xai' | 'qwen3-coder' | 'deepseek-r1', baseURL: string | undefined): Promise<void> {
    await this.ensureInitialized();
    if (!this.store) {
      throw new Error('Configuration store not initialized');
    }
  ...
  async getBaseURL(provider: 'openai' | 'google' | 'azure' | 'xai' | 'qwen3-coder' | 'deepseek-r1'): Promise<string | undefined> {
    await this.ensureInitialized();
    if (!this.store) {
      throw new Error('Configuration store not initialized');
    }
